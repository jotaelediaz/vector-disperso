...
private: // parte privada
    ...
    /**
     * Diccionario que aloja el vector disperso (solo los != valor nulo)
    */
    map<int, T > vd;
...
class iterator{
  ...
  private:
     ...
     */
    typename map<int,T>::iterator ite_rep;
...
class const_iterator{
    ...
    private:
        ...
        * Iterador a la representacion
        */
        typename map<int,T>::const_iterator ite_rep;
...
class stored_iterator{
    ...
    private:
        ...
        /**
         * Iterador al diccionario vd interno del vector
         */
...
class const_stored_iterator{
  ...
  public:
    ...
    */
    const pair<const int, T > & operator *(  );
